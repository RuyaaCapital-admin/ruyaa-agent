          ...
          {stepperData.map((step, index) => (
            <div key={step.id} className="relative flex items-start gap-8">
              ...
              <div className="relative flex-shrink-0">
                ...
                {/* Step number badge */}
                <div className="absolute -top-2 -left-2 w-6 h-6 bg-gradient-to-br from-gray-700 to-gray-800 rounded-full flex items-center justify-center border border-gray-600 text-white text-xs font-bold">
                  {step.id}
                </div>
              </div>
              ...
              <div className="flex-1 pb-8">
                ...
                <div className="relative">
                  ...
                  {/* Main card */}
                  <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl rounded-xl border border-gray-800/50 p-6 shadow-2xl">
                    {/* Subtle border glow */}

  ...
  return (
    <div className="w-full max-w-4xl mx-auto text-center" dir="rtl">
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12">
        {/* ChatGPT */}
        <a
          href="https://chatgpt.com/g/g-68753b21dc948191908c3e7f1310504f-ruyaacapital-smart-agent"
          target="_blank"
        ...
        {/* Instagram */}
        <a
          href="https://www.instagram.com/ruyaa.ai?igsh=MW8zYm4wb291OGNsbQ%3D%3D&utm_source=qr"
          target="_blank"
          rel="noopener noreferrer"
          className="group relative cursor-pointer"
        >

...
export default function ChatWidget() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 sm:bottom-6 sm:right-6 sm:left-auto sm:top-auto sm:inset-auto z-50 sm:w-auto sm:max-w-md mobile-chat-container sm:mobile-chat-container-none"
      style={{ top: "auto", height: "60vh", maxHeight: "500px" }}
    >
